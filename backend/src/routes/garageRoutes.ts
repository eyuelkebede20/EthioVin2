...
import { createCustomer, listCustomers, createJob, listJobs, getJob, updateJob, createAppointment, listAppointments, updateAppointment, createPart, listParts, updatePart } from "../controllers/garageController.ts";
